...
class Store_sceen2 extends StatefulWidget {
  const Store_sceen2 ({Key? key}) : super(key: key);

  @override
  State<Store_sceen2> createState() => _Store_sceen2State();
}

class _Store_sceen2State extends State<Store_sceen2> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  child: ListView.builder(itemBuilder: (context, index) => gameBox(Img[index],Name[index]),shrinkWrap: true,itemCount: 4),
                ),
              ),
            ],
          ),
